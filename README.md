# Rogue-pong
This project is a simple Pong clone to practice game programming patterns and build an engine.
...
Also, it is possible to run the game using the command `./gradlew run` in the project's root folder.
